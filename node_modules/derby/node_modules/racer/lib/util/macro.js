...
var compile, condition, existsSync, files, fs, join, normalize, path, watch;
...
normalize = path.normalize, join = path.join;
...
exports.compile = compile = function(filename) {
  var content, defs, line, match, script, warn, _i, _len, _ref;
